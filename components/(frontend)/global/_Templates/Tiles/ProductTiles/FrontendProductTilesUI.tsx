...
// icons
import { ChevronLeftIcon, ChevronRightIcon, StarIcon, Zap } from "lucide-react";
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <div
                    className={` ${type === "scrollable" ? "line-clamp-1" : "line-clamp-2 pt-0.5 max-sm:pb-0.5"} leading-tight`}
                  >
                    {name}
                  </div>
                ...
                earliestDeliveryBy.length > 0 ? (
                  ...
                  >
                    <div className="flex items-center justify-start gap-x-1.5 bg-gradient-to-r from-transparent to-charcoal-3/15 w-fit pr-3 py-1 rounded-lg">
                      <Zap
                        strokeWidth={1.5}
                        width={15}
                        height={15}
                      ...
                      />
                      {/* <span className="max-sm:text-[12.5px] text-sm text-charcoal-3/80 transition-all duration-300">
                          Earliest:
                        </span> */}
                      <span className="max-sm:text-[12.5px] text-sm text-charcoal-3/90 font-medium">
                        {earliestDeliveryBy}
                      </span>
                    </div>
                  </div>
