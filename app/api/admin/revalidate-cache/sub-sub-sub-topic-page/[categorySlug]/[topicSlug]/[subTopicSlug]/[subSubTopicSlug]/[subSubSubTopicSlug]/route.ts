...
export const GET = async (
  req: NextRequest,
  {
    ...
    params: Promise<{ categorySlug: string; topicSlug: string; subTopicSlug: string, subSubTopicSlug: string, subSubSubTopicSlug: string }>;
  }
): Promise<NextResponse> => {
  try {
    const { categorySlug, topicSlug, subTopicSlug, subSubTopicSlug, subSubSubTopicSlug } = await params;
